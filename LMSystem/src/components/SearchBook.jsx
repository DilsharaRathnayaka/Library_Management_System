  ...
  return (
    <div className="min-h-screen bg-[#f4e5ff] flex flex-col">
      <div className="container mx-auto p-4 flex-grow">
        <h2 className="text-center text-4xl font-bold text-white-600 mb-6">Search Books</h2>
        ...
        {filteredBooks.length === 0 ? (
          <p className="text-center text-xl text-black">No books found matching your search.</p>
        ) : (
